...
def redirect_society(request):
	...
	return redirect(request.user.spfuser.society.shortname+"/")
...
def index(request, society_name):
	...
	return render(request, "society/index.jinja", { 'society': Society.objects.get(shortname=society_name), 'cur_page': 'society' })
