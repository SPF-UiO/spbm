    ...
    state_operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(to='society.Event')),
                ('norlonn_report',
                 models.ForeignKey(to='norlonn.NorlonnReport', null=True, verbose_name='norl&oslash;nn report',
                                   related_name='in_report', blank=True, on_delete=django.db.models.deletion.SET_NULL)),
                ('worker', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, verbose_name='worker',
